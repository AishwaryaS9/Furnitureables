...
// interface GeminiProductDetails {
//     title: string;
//     description: string;
//     skuBase: string;
//     type?: string;
...
// /**
//  * Turns a model-suggested SKU base (e.g. "CHR-OAK-BRN") into a guaranteed
//  * unique SKU by appending a short random suffix and checking it against
//  * the database, retrying on the rare collision.
//  */
