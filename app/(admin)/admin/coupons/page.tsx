...
//     return <main className="w-full max-w-7xl mx-auto space-y-6 sm:space-y-8">
//         <header className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
//             <div><h1 className="font-serif text-3xl sm:text-4xl tracking-tight text-foreground">Coupons</h1><p className="mt-2 max-w-2xl text-xs sm:text-sm font-light leading-relaxed text-muted-foreground">Create and manage customer offers, seasonal sales, and new-user discounts from one place.</p></div>
