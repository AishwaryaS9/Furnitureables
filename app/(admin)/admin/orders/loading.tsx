...
export default function OrdersLoading() {
    return (
        ...
        >
            <span className="sr-only">Loading orders data...</span>

            {/* Header Skeleton */}
            <div className="space-y-2">
                <Skeleton className="h-9 sm:h-10 lg:h-11 w-32 rounded-lg" />
            ...
            <div className="space-y-4 w-full">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 w-full">
                        ...
                        <div className="flex flex-row items-center gap-3 w-full lg:w-auto shrink-0">
                            <Skeleton className="h-11 w-1/2 lg:w-44 rounded-2xl" />
                            <Skeleton className="h-11 w-1/2 lg:w-50 rounded-2xl" />
                        </div>
                    </div>
                    <Skeleton className="h-4 w-36 rounded-md shrink-0 hidden sm:block" />
                </div>
                            ...
                            <TableHeader>
                                <TableRow className="border-b border-border/70 bg-muted/50">
                                    ...
                                    <TableHead className="py-3.5 text-right">
                                        <Skeleton className="h-3.5 w-14 ml-auto rounded-md" />
                                    </TableHead>
